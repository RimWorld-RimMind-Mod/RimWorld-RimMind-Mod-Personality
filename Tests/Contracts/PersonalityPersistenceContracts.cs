            ...
            ContractCaseRunner.Run(
                ...
                ("every settings field participates in Scribe persistence with stable defaults", () =>
                {
                    ...
                    string[] persistedFields =
                    {
                        ...
                        "enableDeathTrigger",
                        "enableSunriseTrigger",
                        "sunriseTriggerChance",
                        "enableRecreationTrigger",
                        "recreationTriggerChance",
                        "enableSkygazeTrigger",
                        "skygazeTriggerChance",
                        "enableMoodSwingTrigger",
                        "moodSwingTriggerChance",
                    ...
                    Assert.Equal(
                        new (string Label, object? DefaultValue)[]
                        {
                            ...
                            ("enableSunriseTrigger", true),
                            ("sunriseTriggerChance", 0.30f),
                            ("enableRecreationTrigger", true),
                            ("recreationTriggerChance", 0.25f),
                            ("enableSkygazeTrigger", true),
                            ("skygazeTriggerChance", 0.40f),
                            ("enableMoodSwingTrigger", true),
                            ("moodSwingTriggerChance", 0.50f),
