...
namespace RimMind.Personality
{
    ...
    public class AIPersonalitySettings : ModSettings
    {
        ...
        /// </summary>
        public float thoughtCountMu = 1.5f;
        ...
        public ThoughtDurationMode durationMode = ThoughtDurationMode.Fixed;
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Values.Look(ref thoughtCountMu,        "thoughtCountMu",        1.5f);
            Scribe_Values.Look(ref thoughtDurationHours,  "thoughtDurationHours",  24f);
            Scribe_Values.Look(ref durationMode,          "durationMode",          ThoughtDurationMode.Fixed);
